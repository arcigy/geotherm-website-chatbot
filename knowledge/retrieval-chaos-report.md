...
Generated: 2026-06-02T04:57:00.254Z
...
| C006 | multi_intent_confusion | PASS | confident | Firemne fakty, ktore nesmie chatbot hadat | dotacia servis cena cerpadlo |
| C007 | multi_intent_confusion | PASS | confident | Firemne fakty, ktore nesmie chatbot hadat | nibe hluk cena servis |
| C008 | vague_queries | PASS | none | - | co s tym |
| C009 | vague_queries | PASS | none | - | oplati sa |
| C010 | conflicting_keywords | PASS | uncertain | Ako rozmýšľať nad značkou, cenou a dodávateľom tepelného čerpadla | najlacnejsie najtichsie najvykonnejsie |
| C011 | source_collisions | PASS | confident | Cena tepelneho cerpadla a kompletnej realizacie | kontakt cena navrh vykurovania |
| C012 | boilerplate_dominance | PASS | confident | Kontakt | kontakt ochrana osobnych udajov formular |
...
| C016 | retrieval_drift | PASS | confident | Scenar novostavba s podlahovym kurenim | podlahove kurenie cena skladba |
