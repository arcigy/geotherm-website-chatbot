...
1. Add randomized/adversarial long-flow tests that combine multiple services, vague follow-ups, contradictions and correction turns.
2. Add scheduled/live monitoring for provider resilience over time, not only one local repeated-run batch.
