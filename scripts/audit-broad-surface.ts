...
const cases: Case[] = [
  ...
  { id: "photovoltaics_standalone", message: "Robite fotovoltaiku?", mustContain: ["fotovolt"], minSources: 1, expectedServiceType: "complex_solution" },
  { id: "solar_collector_tank", message: "Robite solarny ohrev vody so zasobnikom?", mustContain: ["solar", "kolektor"], minSources: 1, expectedServiceType: "complex_solution" },
  ...
  { id: "photovoltaics", message: "Robíte fotovoltaiku k tepelnému čerpadlu?", mustContain: ["fotovolt"], minSources: 1, expectedServiceType: "complex_solution" },
  ...
  { id: "preventive_heat_pump_service", message: "Pravidelny servis tepelneho cerpadla", mustContain: ["servis", "poruch"], minSources: 1, expectedServiceType: "service", expectedServiceIntent: "process" },
  ...
  { id: "certification_gas", message: "Máte certifikáciu na plynové zariadenia?", mustContain: ["potvr"], mustNotContain: ["áno"], expectedServiceType: "service" },
  { id: "boiler_certificate", message: "Potrebujem potvrdenie alebo certifikat ku kotlu", mustContain: ["doklad", "kot"], mustNotContain: ["garant"], minSources: 1, expectedServiceType: "service" },
  ...
  { id: "callout_price", message: "Aka je cena vyjazdu?", mustContain: ["potvr"], mustNotContain: ["garant", "presne"], minSources: 1 },
  { id: "service_wait_time", message: "Aka je cakacia doba na servis?", mustContain: ["potvr"], mustNotContain: ["garant"], minSources: 1 },
  { id: "existing_boiler_service", message: "Robite aj servis existujucich kotlov?", mustContain: ["kot"], minSources: 1 },
  { id: "gas_revision", message: "Robite pravidelne revizie plynu?", mustContain: ["potvr", "plyn"], mustNotContain: ["ano"], minSources: 1 },
  ...
  { id: "project_help", message: "Viete zabezpecit aj projekt?", mustContain: ["projekt"], minSources: 1 },
  { id: "business_customers", message: "Robite aj pre firmy?", mustContain: ["potvr"], mustNotContain: ["ano"], minSources: 1 },
  { id: "apartment_buildings", message: "Robite aj bytove domy?", mustContain: ["potvr"], mustNotContain: ["ano"], minSources: 1 },
